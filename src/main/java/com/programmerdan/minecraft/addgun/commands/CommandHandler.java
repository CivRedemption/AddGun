...
public class CommandHandler implements CommandExecutor, TabCompleter {
	...
	private final PluginCommand giveGun;
	private final PluginCommand giveBullet;
	private final PluginCommand giveMag;
	private final PluginCommand repairGun;
	
	private final PluginCommand giveSelfGun;
	private boolean giveSelfGunEnabled = false;
	private int giveSelfGunLimit = 0;
	private final Map<UUID, Integer> selfGunLimits = new ConcurrentHashMap<UUID, Integer>();
	private long giveSelfGunTimeout = 0;
	private boolean giveSelfGunReset = false;
	private final Map<UUID, Long> selfGunTimeouts = new ConcurrentHashMap<UUID, Long>();
	
	private final PluginCommand giveSelfBullet;
	private boolean giveSelfBulletEnabled = false;
	private int giveSelfBulletLimit = 0;
	private final Map<UUID, Integer> selfBulletLimits = new ConcurrentHashMap<UUID, Integer>();
	private long giveSelfBulletTimeout = 0;
	private boolean giveSelfBulletReset = false;
	private final Map<UUID, Long> selfBulletTimeouts = new ConcurrentHashMap<UUID, Long>();
	
	private final PluginCommand giveSelfMag;
	private boolean giveSelfMagEnabled = false;
	private int giveSelfMagLimit = 0;
	private final Map<UUID, Integer> selfMagLimits = new ConcurrentHashMap<UUID, Integer>();
	private long giveSelfMagTimeout = 0;
	private boolean giveSelfMagReset = false;
	private final Map<UUID, Long> selfMagTimeouts = new ConcurrentHashMap<UUID, Long>();
	
	private final PluginCommand repairSelfGun;
	private boolean repairSelfGunEnabled = false;
	private int repairSelfGunLimit = 0;
	private final Map<UUID, Integer> selfRepairLimits = new ConcurrentHashMap<UUID, Integer>();
	private long repairSelfGunTimeout = 0;
	private boolean repairSelfGunReset = false;
	private final Map<UUID, Long> selfRepairTimeouts = new ConcurrentHashMap<UUID, Long>();
