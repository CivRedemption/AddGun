...
public class Animation implements Runnable{
	...
	private static final Set<PacketPlayOutPosition.EnumPlayerTeleportFlags> flags = new HashSet<>(Arrays.asList(
			PacketPlayOutPosition.EnumPlayerTeleportFlags.a, PacketPlayOutPosition.EnumPlayerTeleportFlags.b, PacketPlayOutPosition.EnumPlayerTeleportFlags.c,
	...
	private final Vector peak;
	private final Vector end;
	
	private Vector[] steps;
	
	private final long beginToPeak;
	private final long peakToEnd;
	...
	public void run() {
		...
		if (player != null) {
			...
			new PacketPlayOutPosition(0.0, 0.0, 0.0, loc.getYaw() - bloc.getYaw(), loc.getPitch() - bloc.getPitch(), flags, 99, false);
		}
	}
}
