...
public class Bullet implements Comparable<Bullet>, Serializable {
	 ...
	 */
	private final Map<HitPart, Double> avgHitDamage = new ConcurrentHashMap<HitPart, Double>();
	//20.0d;
	/**
	 * Damage variation
	 */
	private final Map<HitPart, Double> spreadHitDamage = new ConcurrentHashMap<HitPart, Double>();
	 ...
	 */
	private final Map<ArmorType, Double> armorReduction = new ConcurrentHashMap<ArmorType, Double>();
	 ...
	 */
	private final Map<ArmorType, Double> armorDamage = new ConcurrentHashMap<ArmorType, Double>();
