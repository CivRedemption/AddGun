...
public class Bullets implements Listener {
	...
	private final Map<String, Bullet> tagMap = new ConcurrentHashMap<>();
	
	private final Map<String, Magazine> magazineTagMap = new ConcurrentHashMap<>();
	
	private final Map<String, Bullet> nameMap = new ConcurrentHashMap<>();
	
	private final Map<String, Magazine> magazineMap = new ConcurrentHashMap<>();
	
	private final Map<Material, Set<Bullet>> map = new ConcurrentHashMap<>();
	
	private final Map<Material, Set<Magazine>> magazines = new ConcurrentHashMap<>();
